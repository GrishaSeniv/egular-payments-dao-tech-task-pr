...
public class PaymentInstructionSearch extends Search implements SearchAware {
    ...
    public boolean noPayerrInnFiltering() {
        return payerInn == null || payerInn.isEmpty();
    }

    public boolean noRecipientOkpoFiltering() {
        return recipientOkpo == null || recipientOkpo.isEmpty();
    }

    public String getPayerInn() {
        return payerInn == null ? "" : payerInn;
    }
    ...
    public String getRecipientOkpo() {
        return recipientOkpo == null ? "" : recipientOkpo;
    }
